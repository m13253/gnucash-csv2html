...
def main(argv: List[str]) -> int:
    ...
    fo.write('      <thead>\n')
    fo.write('        <tr><th class="col-date" rowspan="2">Date</th><th class="col-num">Num</th><th class="col-description">Description</th><th class="col-transfer">Transfer</th><th class="col-debit" rowspan="2">Debit</th><th class="col-credit" rowspan="2">Credit</th><th class="col-balance" rowspan="2">Balance</th><th class="col-rate-price" rowspan="2"><div class="inline-block">Rate/<br />Price</div></th></tr>\n')
